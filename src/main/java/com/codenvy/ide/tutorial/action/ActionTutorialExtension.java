...
import com.codenvy.ide.tutorial.action.client.inject.ESBJavaScriptInjector;
import com.codenvy.ide.tutorial.action.client.inject.JSBundle;
...
public class ActionTutorialExtension {
    ...
    public ActionTutorialExtension(ActionManager actionManager, ActionTutorialResources resources, ChangeItemAction changeItemAction,
                                   ...
                                   TutorialHowToPresenter howToPresenter,JSBundle bundle) {
        workspaceAgent.openPart(howToPresenter, EDITING);
         //putting the jquery stuff here
